  ...
  return (
    <div className="flex flex-col min-h-screen w-full items-center justify-start bg-neutral-50 font-sans dark:bg-neutral-950 overflow-y-auto">
      <div className="lg:h-[7vh] md:h-[5vh] h-[6vh] w-full flex justify-center items-center border border-neutral-50 dark:border-neutral-950">
        <div className="h-full lg:w-[60%] w-full flex items-center justify-end md:gap-6 gap-5 border-x border-x-neutral-50 dark:border-x-neutral-950">
          ...
          <p 
           ...
           className="md:text-xs text-[10px] text-stone-800 dark:text-stone-400 dark:hover:text-stone-300 hover:text-stone-600 cursor-pointer">Home</p>
          <p 
           onClick={() => {
           ...
           className="md:text-xs text-[10px] text-stone-800 dark:text-stone-400 dark:hover:text-stone-300 hover:text-stone-600 cursor-pointer">Projects</p>
          <p 
           onClick={() => toast("Work in progress...")}
           className="md:text-xs text-[10px] text-stone-800 dark:text-stone-400 dark:hover:text-stone-300 hover:text-stone-600 cursor-pointer md:block hidden">Blogs</p>
          <p 
           onClick={() => {
           ...
           className="md:text-xs text-[10px] text-stone-800 dark:text-stone-400 dark:hover:text-stone-300 hover:text-stone-600 cursor-pointer">Connect</p>
          {dark ? (
            <SunIcon
              onClick={toggleTheme}
      ...
      <div className="w-full flex justify-center items-stretch border-b border-b-neutral-50 dark:border-b-neutral-950">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          <div className="md:w-[20%] w-[10%] flex items-center justify-center border-r border-r-neutral-50 dark:border-r-neutral-950 dotted-pattern-light">
          ...
          <div className="md:w-[80%] w-[90%] flex flex-col justify-center items-start text-stone-800 dark:text-stone-400 py-5 mr-1.5">
            ...
            <div className="w-full flex items-center justify-start md:gap-5 gap-2 md:mt-4 mt-4">
              ...
              <button 
               onClick={() => window.open("https://drive.google.com/file/d/1sD-K4qpur2E-8INXAyetRt8ZRa6pYLKV/view?usp=sharing", "_blank", "noopener,noreferrer")}
      ...
      <div className="h-[5vh] w-full flex justify-center items-center border-b border-b-neutral-50 dark:border-b-neutral-950">
        <div className="h-full lg:w-[60%] w-full flex items-center justify-start">
          <div className="h-full md:w-[20%] w-[10%]">
      ...
      <div className="w-full flex justify-center items-stretch">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          ...
          <div className="md:w-[80%] w-[90%] flex flex-col items-start justify-center text-stone-800 dark:text-stone-400 py-5">
            <p className="md:ml-5 ml-3 tracking-tight md:text-lg text-base text-black dark:text-white">Skills</p>
            <p className="md:ml-5 ml-3 md:text-xs text-[10px]">Tools & Technologies I work with.</p>
      ...
      <div className="w-full flex justify-center items-stretch border-b border-b-neutral-50 dark:border-b-neutral-950">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          ...
          <div className="md:w-[80%] w-[90%] flex flex-col items-start justify-center text-stone-800 dark:text-stone-400 py-5">
            <p className="md:ml-5 ml-3 tracking-tight md:text-lg text-base text-black dark:text-white">Github</p>
            <p className="md:ml-5 ml-3 md:text-xs text-[10px]">My contributions and activity.</p>
      ...
      <div className="w-full flex justify-center items-stretch border-b border-b-neutral-50 dark:border-b-neutral-950">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          ...
          <div className="md:w-[80%] w-[90%] flex flex-col items-start justify-center text-stone-800 dark:text-stone-400 py-5">
            <p className="md:ml-5 ml-3 tracking-tight md:text-lg text-base text-black dark:text-white">Experience</p>
            ...
            <div className="flex flex-col justify-start items-start w-full mt-5 mr-1.5">
              <div className="flex flex-col justify-start items-start">
                <p className="md:ml-5 ml-3 md:text-sm text-[13px] flex justify-start items-center gap-2 text-stone-900 dark:text-stone-300"><MilestoneIcon className="md:size-4 size-3.5"/>Software Engineer (Contract) |<span className="italic text-stone-700/90 dark:text-stone-400/90 md:text-[11px] text-[10px]">Jan 2026 - July 2026</span></p>
                <p className="md:ml-10 ml-6 mt-2 md:text-[13px] text-xs flex justify-start items-center gap-2 text-stone-700 dark:text-stone-400"><SquareDashedTopSolid className="md:size-3 size-[11px]" />Stealth Legal Startup (United Kingdom, Remote)</p>
                <p className="md:ml-15 ml-10 mt-2 md:text-[11px] text-[10px] flex justify-start md:items-center items-start gap-0.5 text-stone-700/90 dark:text-stone-400/90"><DotIcon className="size-4 self-start" />Architected and shipped core systems for a multi-tenant legal SaaS platform, including tenant isolation, role-based access control, hierarchical permissions, audit logging, and permission-preview workflows</p>
                <p className="md:ml-15 ml-10 mt-2 md:text-[11px] text-[10px] flex justify-start md:items-center items-start gap-0.5 text-stone-700/90 dark:text-stone-400/90"><DotIcon className="size-4 self-start" />Engineered secure document infrastructure with S3-backed storage, signed URL access, versioning, extraction pipelines, search, and permission-aware operations across matters and folders</p>
                <p className="md:ml-15 ml-10 mt-2 md:text-[11px] text-[10px] flex justify-start md:items-center items-start gap-0.5 text-stone-700/90 dark:text-stone-400/90"><DotIcon className="size-4 self-start" />Built AI-assisted time tracking workflows end-to-end, integrating desktop activity ingestion, activity normalization, MS Graph enrichment, intelligent matter assignment, and review-driven timesheet workflows</p>
                <p className="md:ml-15 ml-10 mt-2 md:text-[11px] text-[10px] flex justify-start md:items-center items-start gap-0.5 text-stone-700/90 dark:text-stone-400/90"><DotIcon className="size-4 self-start" />Developed a client-facing forms platform with visual form building, versioned templates, encrypted responses, public submission flows, matter-bound forms, and fillable PDF workflows</p>
                <p className="md:ml-15 ml-10 mt-2 md:text-[11px] text-[10px] flex justify-start md:items-center items-start gap-0.5 text-stone-700/90 dark:text-stone-400/90"><DotIcon className="size-4 self-start" />Built production workflows for inbound email filing and external document collection, including sender moderation, attachment handling, tokenized upload requests, and staff review pipelines</p>
                ...
                <p className="md:ml-10 ml-6 mt-2 md:text-[13px] text-xs flex justify-start items-center gap-2 text-stone-700 dark:text-stone-400"><CodesandboxIcon className="md:size-3 size-[11px]" />Dodox.in (India, Remote)</p>
      ...
      <div id="projects" className="w-full flex justify-center items-stretch border-b border-b-neutral-50 dark:border-b-neutral-950">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          <div className="md:w-[20%] w-[10%] flex items-center justify-center border-r border-r-neutral-50 dark:border-r-neutral-950 dotted-pattern-light">

          </div>
          <div className="md:w-[80%] w-[90%] flex flex-col items-start justify-center text-stone-800 dark:text-stone-400 py-5">
            <p className="md:ml-5 ml-3 tracking-tight md:text-lg text-base text-black dark:text-white">Projects</p>
            <p className="md:ml-5 ml-3 md:text-xs text-[10px]">End-to-end stuff I’ve built.</p>
            ...
            <div className="flex flex-col justify-start items-start md:ml-5 ml-3 md:mt-6 mt-8 mr-2">
              <div className="flex md:flex-row flex-col md:items-center items-start justify-start gap-5 w-full">
                ...
                <div className="flex flex-col justify-start gap-0">
                  <div className="w-full flex items-center justify-between">
                    <p className="md:text-base text-sm tracking-tight text-stone-900 dark:text-stone-300">Wiora</p>
                    <div className="flex items-center justify-end md:mr-3 mr-1.5 gap-2">
                      <ExternalLinkIcon 
                       ...
                       className="md:size-[18px] size-[17px] border-r border-r-neutral-50 dark:border-r-neutral-950 pr-1 hover:text-stone-600 dark:hover:text-stone-300 cursor-pointer" />
                      <PlayIcon 
              ...
              <div className="flex md:flex-row flex-col md:items-center items-start justify-start gap-5 w-full mt-10">
                ...
                <div className="flex flex-col justify-start gap-0">
                  <div className="w-full flex items-center justify-between">
                    <p className="md:text-base text-sm tracking-tight text-stone-900 dark:text-stone-300">Whisp</p>
                    <div className="flex items-center justify-end md:mr-3 mr-1.5 gap-2">
                      <ExternalLinkIcon 
                       onClick={() => window.open("https://whisp-blue.vercel.app/", "_blank", "noopener,noreferrer")}
                       className="md:size-[18px] size-[17px] border-r border-r-neutral-50 dark:border-r-neutral-950 pr-1 dark:hover:text-stone-300 hover:text-stone-600 cursor-pointer" />
                      <PlayIcon 
      ...
      <div className="w-full flex justify-center items-stretch border-b border-b-neutral-50 dark:border-b-neutral-950">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          ...
          <div className="md:w-[80%] w-[90%] flex flex-col items-start justify-center text-stone-800 dark:text-stone-400 py-5">
            <p className="md:ml-5 ml-3 tracking-tight md:text-lg text-base text-black dark:text-white">Education</p>
            <p className="md:ml-5 ml-3 md:text-xs text-[10px]">Where I’m studying and what I’m pursuing.</p>
      ...
      <div id="connect" className="w-full flex justify-center items-stretch">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          <div className="md:w-[20%] w-[10%] flex items-center justify-center border-r border-r-neutral-50 dark:border-r-neutral-950 dotted-pattern-light">

          </div>
          <div className="md:w-[80%] w-[90%] flex flex-col items-start justify-center text-stone-800 dark:text-stone-400 py-5">
            <p className="md:ml-5 ml-3 tracking-tight md:text-lg text-base text-black dark:text-white">Connect</p>
            <p className="md:ml-5 ml-3 md:text-xs text-[10px]">Let’s get in touch.</p>
      ...
      <div className="w-full flex justify-center items-stretch border-b border-b-neutral-50 dark:border-b-neutral-950 lg:mb-[1vh] mb-[0.5vh]">
        <div className="lg:w-[60%] w-full flex items-stretch justify-start border-x border-x-neutral-50 dark:border-x-neutral-950">
          <div className="md:w-[20%] w-[10%] flex items-center justify-center border-r border-r-neutral-50 dark:border-r-neutral-950 dotted-pattern-light">

          </div>
          <div className="md:w-[80%] w-[90%] flex flex-col items-start justify-center text-stone-800 dark:text-stone-400">
